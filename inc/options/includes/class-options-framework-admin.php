...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'WBetter主题选项', 'textdomain'),
     ...
     */
	 function options_page() { ?>
		...
		<h2><div class="dashicons dashicons-admin-settings"></div><?php echo esc_html( $menu['page_title'] ); ?><span class="version">版本：1.0</span></h2>
